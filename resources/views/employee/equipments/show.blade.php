...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="bg-white p-6 rounded-3xl shadow-xl border border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div class="flex gap-3">
             <a href="{{ route('employee.equipments.index') }}" class="flex items-center px-5 py-2.5 bg-gray-100 text-gray-600 rounded-xl hover:bg-gray-200 transition font-bold">
