        ...
        <div class="p-8">
            <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('employee.users.index') }}" class="px-5 py-2.5 rounded-xl bg-white/20 backdrop-blur-sm text-white border-2 border-white/30 text-sm font-bold hover:bg-white/30 transition-all flex items-center shadow-lg">
