...
<div class="flex items-center gap-3">
    ...
    <a href="{{ route('equipments.index') }}" class="flex items-center px-5 py-2.5 bg-gray-100 text-gray-600 rounded-xl hover:bg-gray-200 transition font-bold">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-xl border border-gray-100">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
                    <div>
                     ...
                     <div>
                        <dt class="text-xs font-bold text-gray-400 uppercase tracking-wider">Type</dt>
                        <dd class="mt-1 text-gray-900 font-medium">{{ $equipment->type_equipement ?: '-' }}</dd>
                    </div>
            ...
            <!-- History Placeholder -->
             <div class="bg-white p-6 rounded-3xl shadow-xl border border-gray-100 opacity-60">
                 <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                    <i class='bx bx-history mr-2 text-blue-500'></i> Historique (Bientôt disponible)
                </h3>
                <div class="border-l-2 border-dashed border-gray-200 pl-6 py-2 space-y-6">
                    <div class="relative">
                        <div class="absolute -left-[31px] bg-white border-2 border-gray-200 h-4 w-4 rounded-full"></div>
